	...
	return (
		<div className="w-full min-h-screen p-4">
			<div className="mx-auto max-w-415">
				...
				<div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-0.25">
					{story.images.map((item, index) => (
						<Card
							key={index}
							className="relative overflow-hidden cursor-pointer group hover:shadow-2xl p-0 first:mt-0 rounded-none group"
